 ...
 *
 */
class EEG_Montonio_Coop_Payment_Method_Offsite extends EE_Offsite_Gateway{
	...
	/**
	 * @return EEG_Montonio_Coop_Payment_Method_Offsite
	 */
	...
	public function set_redirection_info($payment, $billing_info = array(), $return_url = NULL, $notify_url = NULL, $cancel_url = NULL) {
		...
		$paymentUrl = $this->paymentSdk->getPaymentUrl($payment, 'coop', $notify_url, $return_url );
