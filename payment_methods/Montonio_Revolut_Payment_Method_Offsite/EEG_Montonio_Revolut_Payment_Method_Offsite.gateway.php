 ...
 *
 */
class EEG_Montonio_Revolut_Payment_Method_Offsite extends EE_Offsite_Gateway{
	...
	/**
	 * @return EEG_Montonio_Revolut_Payment_Method_Offsite
	 */
	...
	public function set_redirection_info($payment, $billing_info = array(), $return_url = NULL, $notify_url = NULL, $cancel_url = NULL) {
		...
		$paymentUrl = $this->paymentSdk->getPaymentUrl($payment, 'revolut', $notify_url, $return_url );
