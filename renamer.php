...
<ul>
	...
	<li>search: OPTIONAL string, default is "New_Addon" the old addon's name. This string, and derivatives of it (eg "new-addon" and "new_addon") will be replaced by "replace" (previous GET parameter) and its derivatives. If you copied the "new-payment-method", for example, you should instead provide "Montonio_Payment_Method"</li>
